...
def readNpy():
    train_image = np.load("datas/images_training.npy")
    train_GT    = np.load("datas/annotations_training.npy")
    valid_image = np.load("datas/images_validation.npy")
    valid_GT = np.load("datas/annotations_validation.npy")
